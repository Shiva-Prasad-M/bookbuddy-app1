...
const initialBooks = [
  {
    ...
    genre: "Adventure",
    ageGroup: "7-10",
    coverImage: "/magic-treehouse-book-cover.jpg",
  ...
  },
  {
    ...
    genre: "Fantasy",
    ageGroup: "8-12",
    coverImage: "/charlie-chocolate-factory-book-cover.jpg",
  ...
  },
  {
    ...
    genre: "Humor",
    ageGroup: "9-13",
    coverImage: "/diary-wimpy-kid-book-cover.jpg",
    availabilityType: "Free",
    status: "Available",
    ownerId: 103,
  ...
  },
  {
    ...
    genre: "Fantasy",
    ageGroup: "10-14",
    coverImage: "/harry-potter-sorcerer-stone-book-cover.jpg",
    availabilityType: "Exchange",
    status: "Available",
    ownerId: 104,
  ...
  },
  {
    ...
    genre: "Fiction",
    ageGroup: "7-11",
    coverImage: "/matilda-book-cover.jpg",
    availabilityType: "Free",
    status: "Available",
    ownerId: 105,
  ...
  },
  {
    ...
    genre: "Fantasy",
    ageGroup: "11-14",
    coverImage: "/percy-jackson-lightning-thief-book-cover.jpg",
    availabilityType: "Exchange",
    status: "Available",
    ownerId: 106,
  ...
  },
  {
    ...
    genre: "Classic",
    ageGroup: "6-10",
    coverImage: "/charlottes-web-book-cover.jpg",
    availabilityType: "Free",
    status: "Available",
    ownerId: 107,
  ...
  },
  {
    ...
    genre: "Picture Book",
    ageGroup: "4-7",
    coverImage: "/cat-in-hat-book-cover.jpg",
    availabilityType: "Free",
    status: "Available",
    ownerId: 108,
  ...
  },
  {
    ...
    genre: "Classic",
    ageGroup: "8-12",
    coverImage: "/secret-garden-book-cover.jpg",
    availabilityType: "Exchange",
    status: "Available",
    ownerId: 109,
  ...
  },
  {
    ...
    genre: "Classic",
    ageGroup: "7-12",
    coverImage: "/little-prince-cover.png",
    availabilityType: "Free",
    status: "Available",
    ownerId: 110,
...
const initialState = {
  ...
  currentView: "home" as "home" | "dashboard" | "add-book",
...
function bookReducer(state: any, action: any) {
  switch (action.type) {
    ...
    case "ADD_BOOK":
      const newBook = {
        ...action.payload,
        id: Math.max(...state.books.map((b: any) => b.id)) + 1,
    ...
    case "ADD_REQUEST":
      const newRequest = {
        ...action.payload,
        id: Math.max(...state.requests.map((r: any) => r.id)) + 1,
...
export function BookProvider({ children }: { children: React.ReactNode }) {
  ...
  const filteredBooks = state.books.filter((book: any) => {
    const matchesSearch =
  ...
  const value = {
    ...
    setGenreFilter: (genre: string) => dispatch({ type: "SET_GENRE_FILTER", payload: genre }),
    setAgeGroupFilter: (ageGroup: string) => dispatch({ type: "SET_AGE_GROUP_FILTER", payload: ageGroup }),
    setAvailabilityFilter: (availability: string) =>
      dispatch({ type: "SET_AVAILABILITY_FILTER", payload: availability }),
    setCurrentView: (view: string) => dispatch({ type: "SET_CURRENT_VIEW", payload: view }),
    setSelectedBook: (bookId: number | null) => dispatch({ type: "SET_SELECTED_BOOK", payload: bookId }),
    addBook: (book: any) => dispatch({ type: "ADD_BOOK", payload: book }),
    addRequest: (request: any) => dispatch({ type: "ADD_REQUEST", payload: request }),
